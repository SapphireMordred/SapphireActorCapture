...
namespace SapphireActorCapture.Packets
{
    ...
    public class SubPacket
    {
        ...
        public unsafe SubPacket(byte[] bytes, ref uint offset)
        {
        ...
        public void DebugPrintSubPacket()
        {
            ...
            if (header.type == 0x03)
            {
                Console.WriteLine(Utils.ByteArrayToHex(GetGameMessageBytes(), SUBPACKET_SIZE));

                Console.WriteLine(Utils.ByteArrayToHex(data, SUBPACKET_SIZE + GAMEMESSAGE_SIZE));
            }
#endif
        }
